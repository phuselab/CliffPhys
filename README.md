...
Demo code for the paper [CliffPhys: Camera-based Respiratory Measurement using Clifford Neural Networks](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/11393.pdf) (ECCV 2024)
